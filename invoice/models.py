...
class InvoiceItem(models.Model):
    ...
    taxable = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)  # Default value
    cgst = models.DecimalField(max_digits=5, decimal_places=2, default=0.00)  # Default value
    sgst = models.DecimalField(max_digits=5, decimal_places=2, default=0.00)  # Default value
    igst = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, default=0.00)  # Default value
    ...
    def __str__(self):
        return f"{self.product} in Invoice {self.invoice.invoice_no}"
